        ...
        for (vector<string>::iterator it=species.begin(); it!=species.end(); ++it)
            ...
            myfile << "Elaspsed: " << (double)(toc - tic) / CLOCKS_PER_SEC << "Seconds" << endl;        
        ...
        void CRO::decomposition(int m)
        {
            ...
            peW1 = MP_value_from_tree(w1);
            peW2 = MP_value_from_tree(w2);
        ...
        void CRO::branch_optimization()
        {
            ...
            bo = OptimizationTools::optimizeTreeNNI(bo, bo->getParameters(), true, 100, 0.0001, 30, 1, 0, 0, false, 0,"newton", 3);
        ...
        float CRO::MP_value_from_tree(Tree * tr){
            
            DRTreeParsimonyScore pars(*tr, *sites, true, true);
    ...
    void CRO::init_pop_with_bionj()
        ...
        void CRO::branch(Tree * t)
        {
            ...
            bo->initialize();
            myfile << "Log likelihood before: " << bo->getLogLikelihood() << endl;
            
            //bo = OptimizationTools::optimizeTreeNNI(bo, bo->getParameters(), true, 100, 0.000001, 300, 1, 0, 0, false, 3);
            bo = OptimizationTools::optimizeTreeNNI(bo, bo->getParameters(), true, 100, 0.0001, 100, 1, 0, 0, false, 0,"newton", 3);
            //cout << "Value from optimal tree " << ML_value_from_tree(optimal.structure) << endl;
            myfile << "Log likelihood after: " << bo->getLogLikelihood() << endl;
            myfile << endl;
            //myfile << "Log likelihood after: " << bo->getLogLikelihood() << endl;
